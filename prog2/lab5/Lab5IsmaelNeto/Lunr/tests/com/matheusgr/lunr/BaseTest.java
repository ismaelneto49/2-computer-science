...
public class BaseTest {
    ...
    void setUp() throws Exception {
        ...
        this.documentoController.adicionaDocumentoHtml(HTML_ID, exemplo.sampleHTML(), 5, 5);
        this.documentoController.adicionaDocumentoJava(JAVA_ID, exemplo.sampleJava(), 5, 5);
        this.documentoController.adicionaDocumentoTxt(TEXTO1_ID, "um arquivo! texto simples.\r\nuse DUAS linhas apenas.", 5, 5);
        this.documentoController.adicionaDocumentoTxt(TEXTO2_ID, "um arquivo! texto simples.\r\nuse TRÊS linhas agora.\r\nMAIS AVANÇO!", 5, 5);
        this.documentoController.adicionaDocumentoTxt(TEXTO3_ID, exemplo.sampleTexto(), 5, 5);
    }
