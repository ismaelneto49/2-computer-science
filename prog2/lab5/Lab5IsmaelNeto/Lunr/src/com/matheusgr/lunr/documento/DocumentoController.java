...
public class DocumentoController {
     ...
     * @param qtdPrimeirasLinhas quantidade de linhas usadas na apresentacao de N
     *                           primeiras linhas
     * @param qtdUltimasLinhas   quantidade de linhas usadas na apresentacao de N
     *                           ultimas linhas
     */
    public void adicionaDocumentoTxt(String id, String txt, int qtdPrimeirasLinhas, int qtdUltimasLinhas) {
        this.validador.validacao(id, txt);
        this.ds.adicionaDocumento(new DocumentoTexto(id, txt, qtdPrimeirasLinhas, qtdUltimasLinhas));
    }
     ...
     *                           ultimas linhas
     */
    public void adicionaDocumentoHtml(String id, String html, int qtdPrimeirasLinhas, int qtdUltimasLinhas) {
        this.validador.validacao(id, html);
        this.ds.adicionaDocumento(new DocumentoHtml(id, html, qtdPrimeirasLinhas, qtdUltimasLinhas));
    }
     ...
     *                           ultimas linhas
     */
    public void adicionaDocumentoJava(String id, String java, int qtdPrimeirasLinhas, int qtdUltimasLinhas) {
        this.validador.validacao(id, java);
        this.ds.adicionaDocumento(new DocumentoJava(id, java, qtdPrimeirasLinhas, qtdUltimasLinhas));
    }
