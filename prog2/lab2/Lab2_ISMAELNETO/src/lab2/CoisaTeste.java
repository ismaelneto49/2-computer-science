...
public class CoisaTeste {
    ...
    public static void descanso() {
        ...
        descanso.defineHorasDescanso(0);
        descanso.defineNumeroSemanas(1);
        System.out.println(descanso.getStatusGeral());
        descanso.defineHorasDescanso(26);
        descanso.defineNumeroSemanas(1);
        System.out.println(descanso.getStatusGeral());
        descanso.defineHorasDescanso(90);
    ...
    private static void registroOnline() {
        ...
        tempoLP2.adicionaTempoOnline(100);
        System.out.println(tempoLP2.atingiuMetaTempoOnline());
        tempoLP2.adicionaTempoOnline(-90);
        ...
        tempoP2.adicionaTempoOnline(10);
